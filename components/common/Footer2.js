  ...
  return (
    <footer className="bg-gradient-to-r from-slate-50 to-slate-200">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-12 sm:py-8 lg:px-8">
        ...
        <p className="mt-10 text-center text-md leading-5 text-gray-600">
           Consultoría estratégica y servicios profesionales de diseño gráfico
        </p>

        <p className="mt-4 text-center text-xs leading-5 text-gray-500">
          &copy; Chihuahua, Chih. Mexico © 2024 
        </p>
      </div>
    </footer>
  )
